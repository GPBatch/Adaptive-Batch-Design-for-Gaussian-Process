function [gp, varargout] = gp_optim_amput(gp, x, y, varargin)
...
%           ub = repmat(3.6889,1,size(w,2));
      case 3
          lb = [0, repmat(2.9957,1,d), repmat(0.1,1,size(w,2)-1-d)];   
          ub = [5, repmat(5,1,d), repmat(5,1,size(w,2)-1-d)];
%           ub = repmat(4.6052,1,size(w,2));
  end
  switch nargout
    case 6
