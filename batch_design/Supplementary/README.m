% These two files "seq_design.m" and "updategp.m" are supplementary documents 
...
% with FB, MCU with RB, MCU with MLB and ABSUR. "updategp.m" is the wrapper
...
% https://github.com/VictoriaLyu/Gaussian-Process-with-Batch-Design/