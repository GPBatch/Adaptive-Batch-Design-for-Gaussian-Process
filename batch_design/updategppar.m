...
%%%%%%%%%% This function is used to generate and record the whole synthetic
%%%%%%%%%% experiments results in parallel computing. 
...
[x_seq, y_seq, r_seq, ee, er, bias, metric, t, Ef, Varf, xt, xtt, l, sigma2, sigman, steps, t_optim, t_gen, overhead, gamma, post_var] = intgp(k, m0, d, budget, fun, r);
...
parfor j = 1:k
    ...
    % update gp %
    [x_seq_tmp, y_seq_tmp, r_seq_tmp, metric_tmp, t_tmp, ee_tmp, er_tmp, bias_tmp, Ef_tmp, Varf_tmp, l_tmp, sigma2_tmp, sigman_tmp, steps(j), t_optim_tmp, t_gen_tmp, overhead_tmp, gamma_tmp, post_var_tmp] = updategp(fun, noisestructure, noisevar, Xint, xt, model, design, budget, xtt, r, ft, pcr, lambda, batch, t0);
